...
import { getGstAccountingById } from 'apiSdk/gst-accountings';
import { GstAccountingInterface } from 'interfaces/gst-accounting';

function GstAccountingViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('gst_accounting', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/gst-accountings/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Gst Number" text={data?.gst_number} />

                <FormListItem label="Accounting Data" text={data?.accounting_data} />
