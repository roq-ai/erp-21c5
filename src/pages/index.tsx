  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience ERP - Streamlining Processes, Automating Tasks, and Enhancing Employee Experience for Optimal Productivity and Organizational Success."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1581091877018-dac6a371d50f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxFUlB8ZW58MHx8fHwxNjkwNzk4MzI5fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience ERP - Streamlining Processes, Automating Tasks, and Enhancing Employee Experience for Optimal Productivity and Organizational Success.`}
            </Text>
            <Box
            ...
            >
              <Stack direction="column" spacing={6}>
                <Card userTypeName="Accountant" type="accountant" />
